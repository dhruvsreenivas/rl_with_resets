...
def update(
    ...
    assert not (
        use_mean_reduction and use_max_reduction
    ), "Can't have both mean and max being used."
    ...
    def critic_loss_fn(critic_params: Params) -> Tuple[jnp.ndarray, InfoDict]:
        ...
        (_, (q1, q2)), action_grad = jax.value_and_grad(_critic_fn, has_aux=True)(
            batch.actions
        )
